...
Watson Conversation is a chatbot service, one of many AI services offered by IBM
to integrate cognitive computing into your applications. With the use of this
plugin, you can easily add chatbots to your website created using the Watson
...
1. From the Deploy tab, you can obtain your username and password credentials in
addition to the Workspace ID of your new workspace. Enter these in the Workspace
Credentials section of the settings page for your Watson Conversation plugin on
Wordpress.
...
Watson Conversation, when used with this plugin, allows you to build and deploy
a fully customized chat bot with little technical knowledge. It can talk to your
website's visitors about whatever you choose, from helping navigate the website
and providing support with common questions, to just having a casual
